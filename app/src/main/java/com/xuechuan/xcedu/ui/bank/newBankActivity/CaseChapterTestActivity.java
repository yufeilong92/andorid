 ...
 */
public class CaseChapterTestActivity extends BaseActivity implements View.OnClickListener, CaseInterface {
    /**
     * 章节id
     */
    ...
    private LinearLayout mCaseChapterRootLayout;

    public static Intent start_Intent(Context context, int id, String mCouersid) {
        Intent intent = new Intent(context, CaseChapterTestActivity.class);
    ...
    /*  @Override
      protected void onCreate(Bundle savedInstanceState) {
          ...
          setContentView(R.layout.activity_case_chapter_test);
          initView();
      }
  */
    @Override
    protected void initContentView(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            //科目id
            mCourseId = getIntent().getStringExtra(COUERSID);
        }
        initView();
        initUtils();
    ...
    public List<CaseCardVo> getLists() {
        List<QuestionCaseVo> list = mQuestionSqliteHelp.queryAllChapterQuestionListData(mChapter_Id, mCourseId);
    ...
    private ArrayList<CaseCardVo> initCaseData() {
        List<CaseCardVo> caseCardVo = mDataListUtil.getCaseCardVo();
        ArrayList<CaseCardVo> vos = new ArrayList<>();
        for (int i = 0; i < caseCardVo.size(); i++) {
            vos.add(caseCardVo.get(i));
        }
        return vos;
    }
        ...
        if (mDoLogProgressSqliteHelp != null) {
            if (mMainDataLists != null && !mMainDataLists.isEmpty()) {
                final DoLogProgreeSqliteVo look = mDoLogProgressSqliteHelp.findLookWithTidChapterId(
                        DataMessageVo.CASE_ORDER_MAKE, Integer.parseInt(mCourseId), DataMessageVo.CHAPTER_ONE);
                if (look == null) return;
...
mReaderViewPager.setOffscreenPageLimit(3);
    ...
    private void initView() {
        ...
        mCaseChapterRootLayout = (LinearLayout) findViewById(R.id.case_chapter_root_layout);
        mCaseChapterRootLayout.setOnClickListener(this);
    }
...
/*        String d = EncryptionUtil.D(vo.getQuestion());
    ...
    private static String TAG = "【" + CaseChapterTestActivity.class + "】==";
...
//                                saveAnsysicDataEvent(curPosition2);
    ...
    private void showAnswerCardLayout() {
            ...
            protected void initWindow() {
                ...
                instance.setOnDismissListener(new PopupWindow.OnDismissListener() {
                    ...
                    public void onDismiss() {
                        mTextUtil.setBackgroundAlpha(1f, CaseChapterTestActivity.this);
                    }
                });
            }
        ...
        mPopAnswer.showAtLocation(mCaseChapterRootLayout, Gravity.BOTTOM, 0, 0);
        mTextUtil.setBackgroundAlpha(0.5f, CaseChapterTestActivity.this);
    }
