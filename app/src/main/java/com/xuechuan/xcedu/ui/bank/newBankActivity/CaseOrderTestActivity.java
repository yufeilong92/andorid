 ...
 */
public class CaseOrderTestActivity extends BaseActivity implements View.OnClickListener, CaseInterface {
    ...
    private LinearLayout mCaseOrderRootLayout;
...
/*    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_case_order_test);
        initView();
    }*/
    ...
    public List<CaseCardVo> getLists() {
        List<QuestionCaseVo> list = mQuestionSqliteHelp.queryAllQuesitonCaseWithCouresid(mCourseId);
    ...
    private void initView() {
        ...
        mCaseOrderRootLayout = (LinearLayout) findViewById(R.id.case_order_root_layout);
        mCaseOrderRootLayout.setOnClickListener(this);
    }
...
//                                saveAnsysicDataEvent(curPosition2);
    ...
    private void showAnswerCardLayout() {
        ...
        mPopAnswer.showAtLocation(mCaseOrderRootLayout, Gravity.BOTTOM, 0, 0);
