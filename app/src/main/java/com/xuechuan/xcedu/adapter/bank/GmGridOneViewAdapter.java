 ...
 */
public class GmGridOneViewAdapter extends BaseAdapter {
    ...
    public GmGridOneViewAdapter(Context mContext, List<?> mData) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final QuestionCaseVo vo = (QuestionCaseVo) mData.get(position);
