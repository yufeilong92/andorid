 ...
 */
public class GmMockExamGridViewAdapter extends BaseAdapter {
    ...
    public GmMockExamGridViewAdapter(Context mContext, List<?> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        QuestionCaseVo vo = (QuestionCaseVo) mData.get(position);
